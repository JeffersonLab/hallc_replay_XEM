...
Double_t stub_x[2][200];
 ...
 TH1F* h_dist2[2];
   ...
   hW_chisq = new TH2F("hW_chisq",temp,200,.55,1.1,500,0,1000);
   HList.Add(hW_chisq);
   temp=Form("Run %d ; W ; Counts",nrun);
   hW = new TH1F("hW",temp,200,.55,1.1);
   HList.Add(hW);
   temp=Form("Run %d ; W (chi2 >20); Counts",nrun);
   hW_cut = new TH1F("hW_cut",temp,200,.55,1.1);
   HList.Add(hW_cut);
   temp=Form("Run %d ; W (chi2 >100); Counts",nrun);
   hW_cut1 = new TH1F("hW_cut1",temp,200,.55,1.1);
   HList.Add(hW_cut1);
   temp=Form("Run %d ; W (chi2 <100); Counts",nrun);
   hW_cutlo = new TH1F("hW_cutlo",temp,200,.55,1.1);
   HList.Add(hW_cutlo);
