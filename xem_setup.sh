...
if [[ ifarm_flg -eq 1 ]]; then
	...
	mkdir $base_dir_voli$USER"/REPORT_OUTPUT/COIN/SCALERS"
	...
	mkdir $base_dir_voli$USER"/REPORT_OUTPUT/SHMS/SCALERS"
	...
	mkdir $base_dir_voli$USER"/REPORT_OUTPUT/HMS/SCALERS"
	...
	mkdir $base_dir_voli$USER"/ROOTfiles/COIN/SCALERS"
	...
	mkdir $base_dir_voli$USER"/ROOTfiles/SHMS/SCALERS"
	...
	mkdir $base_dir_voli$USER"/ROOTfiles/HMS/SCALERS"
...
if [[ cdaq_flg -eq 1 ]]; then
    ...
    mkdir $base_dir_cdaq"/REPORT_OUTPUT/COIN/SCALERS"
    ...
    mkdir $base_dir_cdaq"/REPORT_OUTPUT/SHMS/SCALERS"
    ...
    mkdir $base_dir_cdaq"/REPORT_OUTPUT/HMS/SCALERS"
    ...
    mkdir $base_dir_cdaq"/ROOTfiles/COIN/SCALERS"
    ...
    mkdir $base_dir_cdaq"/ROOTfiles/SHMS/SCALERS"
    ...
    mkdir $base_dir_cdaq"/ROOTfiles/HMS/SCALERS"
