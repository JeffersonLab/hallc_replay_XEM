...
void replay (Int_t RunNumber=0, Int_t MaxEvent=0) {
  ...
  TString odef_file = "DEF-files/HMS/PRODUCTION/HMS_PedDefault.def";
  TString cdef_file = "DEF-files/HMS/PRODUCTION/CUTS/hstackana_production_cuts.def";
  TString summary_file = Form("REPORT_OUTPUT/HMS/CALIBRATION/summary_hms_setPedDefault_%d_%d.report", RunNumber, MaxEvent);
  TString report_file  = Form("REPORT_OUTPUT/HMS/CALIBRATION/replay_hms_setPedDefault_%d_%d.report", RunNumber, MaxEvent);
