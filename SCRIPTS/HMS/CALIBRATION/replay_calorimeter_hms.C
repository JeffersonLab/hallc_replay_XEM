...
void replay_calorimeter_hms(Int_t RunNumber=0, Int_t MaxEvent=0) {
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/HMS/CALIBRATION/hms_replay_cal_%d_%d.root";
  TString ROOTFileName = Form(ROOTFileNamePattern, RunNumber, MaxEvent);
  //Specifics for the replay
  TString odef_file = "DEF-files/HMS/CALIBRATION/hcal_calibration.def";
