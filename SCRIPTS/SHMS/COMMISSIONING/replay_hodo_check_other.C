...
void replay_hodo_check_other (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/SHMS/HODO_FIX/shms_replay_hodo_check_%d_%d.root";
