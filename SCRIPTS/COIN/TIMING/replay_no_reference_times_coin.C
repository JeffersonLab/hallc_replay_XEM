void replay_no_reference_times_coin (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  gHcParms->AddString("g_ctp_no_shms_reference_times_filename", "PARAM/SHMS/GEN/p_no_reference_times.param");
  gHcParms->Load(gHcParms->GetString("g_ctp_no_shms_reference_times_filename"));
  gHcParms->AddString("g_ctp_no_hms_reference_times_filename", "PARAM/HMS/GEN/h_no_reference_times.param");
  gHcParms->Load(gHcParms->GetString("g_ctp_no_hms_reference_times_filename"));
